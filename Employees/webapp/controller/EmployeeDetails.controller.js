//@ts-nocheck
sap.ui.define([
    "abrahamgroup/Employees/controller/Base.controller",
    "abrahamgroup/Employees/model/formatter",
    "sap/m/MessageBox"
],
    function (Base, formatter, MessageBox) {
        ...
        function onCreateIncidence() {
            ...
            var newIncidence = sap.ui.xmlfragment("abrahamgroup.Employees.fragment.NewIncidence", this);
        ...
        function updateIncidenceCreationDate(oEvent) {
            ...
            if (!oEvent.getSource().isValidValue()) {
                ...
                MessageBox.error(oResourceBundle.getText("errorCreationDateValue"), {
                    ...
                    onClose: null,
                    styleClass: "",
                    action: MessageBox.Action.CLOSE,
        ...
        var EmployeeDetails = Base.extend("abrahamgroup.Employees.controller.EmployeeDetails", {});
