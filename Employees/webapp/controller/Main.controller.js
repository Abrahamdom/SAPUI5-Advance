...
sap.ui.define([
    ...
    function (Controller, MessageBox) {
        ...
        return Controller.extend("abrahamgroup.Employees.controller.Main", {
                ...
                this.getView().getModel("incidenceModel").read("/IncidentsSet", {
                    ...
                    success: function (data) {
                        ...
                        for (var incidence in data.results) {
                            ...
                            var newIncidence = sap.ui.xmlfragment("abrahamgroup.Employees.fragment.NewIncidence", this._detailEmployeeView.getController());
